...
def build_loader(batch_size):
    ...
    print(
        f"Shape of x_train_filtered: {x_train_filtered.shape}, y_train_filtered: {y_train_filtered.shape}"
    )
    print(
        f"Shape of x_val_filtered: {x_val_filtered.shape}, y_val_filtered: {y_val_filtered.shape}"
    )
    print(
        f"Shape of x_test_filtered: {x_test_filtered.shape}, y_test_filtered: {y_test_filtered.shape}"
    )
    ...
    train_loader_linear = DataLoader(
        train_dataset_linear, batch_size=batch_size, shuffle=True
    )
    val_loader_linear = DataLoader(
        val_dataset_linear, batch_size=batch_size, shuffle=False
    )
    test_loader_linear = DataLoader(
        test_dataset_linear, batch_size=batch_size, shuffle=False
    )
    ...
    train_loader_linear_filtered = DataLoader(
        train_dataset_linear_filtered, batch_size=batch_size, shuffle=True
    )
    val_loader_linear_filtered = DataLoader(
        val_dataset_linear_filtered, batch_size=batch_size, shuffle=False
    )
    test_loader_linear_filtered = DataLoader(
        test_dataset_linear_filtered, batch_size=batch_size, shuffle=False
    )
    ...
    return {
        "train_loader_linear": train_loader_linear,
        "val_loader_linear": val_loader_linear,
        "test_loader_linear": test_loader_linear,
        "train_loader_linear_filtered": train_loader_linear_filtered,
        "val_loader_linear_filtered": val_loader_linear_filtered,
        "test_loader_linear_filtered": test_loader_linear_filtered,
